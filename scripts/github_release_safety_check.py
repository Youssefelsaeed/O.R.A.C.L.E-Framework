...
RELEASE_SCRIPT_NAMES = {
    ...
    "check_live_sensor_readiness.py",
    "test_module_gui_actions.py",
    "test_module_pages_operator_ui.py",
    "docker_oracle_common.py",
    "docker_oracle_up.py",
    "docker_oracle_down.py",
    "docker_oracle_status.py",
    "docker_oracle_logs.py",
    "check_docker_packaging_safety.py",
    "test_docker_oracle_runtime.py",
    "oracle_phase12_17_common.py",
    "oracle_phase12_17_stack_boot_test.py",
    "oracle_phase12_17_backend_endpoint_test.py",
    "oracle_phase12_17_gui_action_test.py",
    "oracle_phase12_17_request_handling_test.py",
    "oracle_phase12_17_live_replay_gui_update_test.py",
    "oracle_phase12_17_reports_docs_test.py",
    "oracle_phase12_17_issue_sweep.py",
    "oracle_phase12_17_final_operational_verification.py",
    "oracle_phase12_18_common.py",
    "oracle_phase12_18_clean_runtime_reset.py",
    "oracle_phase12_18_feature_mapping_audit.py",
    "oracle_phase12_18_mutantshield_standalone_eval.py",
    "oracle_phase12_18_full_stack_dataset_eval.py",
    "oracle_phase12_18_metric_truth_comparison.py",
    "oracle_phase12_18_request_handling_rerun.py",
    "oracle_phase12_18_detection_truth_audit.py",
    "oracle_phase12_18b_common.py",
    "oracle_phase12_18b_hard_runtime_reset.py",
    "oracle_phase12_18b_build_balanced_eval_sets.py",
    "oracle_phase12_18b_detector_routing_audit.py",
    "oracle_phase12_18b_mutantshield_controlled_eval.py",
    "oracle_phase12_18b_full_stack_controlled_eval.py",
    "oracle_phase12_18b_compare_original_mutantshield_metrics.py",
    "oracle_phase12_18b_final_detection_verdict.py",
    "oracle_phase12_18b_request_handling_final_rerun.py",
    "oracle_phase12_18b_final_detection_verification.py",
    "oracle_phase12_18b_common.py",
    "oracle_phase12_18b_hard_runtime_reset.py",
    "oracle_phase12_18b_build_balanced_eval_sets.py",
    "oracle_phase12_18b_detector_routing_audit.py",
...
ALLOWED_STAGED_REPORTS = {
    ...
    "reports/final/live_sensor_readiness_report.json",
    "reports/final/module_gui_actions_report.json",
    "reports/final/module_gui_data_source_audit.json",
    "reports/final/module_pages_operator_ui_report.json",
    "reports/final/docker_packaging_safety_report.json",
    "reports/final/docker_oracle_runtime_test_report.json",
    "reports/final/phase12_17_stack_boot_test.json",
    "reports/final/phase12_17_backend_endpoint_test.json",
    "reports/final/phase12_17_gui_action_test.json",
    "reports/final/phase12_17_request_handling_test.json",
    "reports/final/phase12_17_live_replay_gui_update_test.json",
    "reports/final/phase12_17_reports_docs_test.json",
    "reports/final/phase12_17_issue_sweep.json",
    "reports/final/phase12_17_final_operational_verification.json",
    "reports/final/phase12_18_clean_runtime_reset.json",
    "reports/final/phase12_18_feature_mapping_audit.json",
    "reports/final/phase12_18_feature_mapping_audit.md",
    "reports/final/phase12_18_mutantshield_standalone_eval.json",
    "reports/final/phase12_18_mutantshield_standalone_eval.md",
    "reports/final/phase12_18_full_stack_dataset_eval.json",
    "reports/final/phase12_18_full_stack_dataset_eval.md",
    "reports/final/phase12_18_metric_truth_comparison.json",
    "reports/final/phase12_18_metric_truth_comparison.md",
    "reports/final/phase12_18_request_handling_rerun.json",
    "reports/final/phase12_18_detection_truth_audit.json",
    "reports/final/phase12_18b_runtime_reset_report.json",
    ...
    "reports/final/phase12_18b_mutantshield_controlled_eval.md",
    "reports/final/phase12_18b_full_stack_controlled_eval.json",
    "reports/final/phase12_18b_full_stack_controlled_eval.md",
    "reports/final/phase12_18b_original_metric_comparison.json",
    "reports/final/phase12_18b_original_metric_comparison.md",
    "reports/final/ORACLE_FINAL_DETECTION_VERDICT.json",
    "reports/final/ORACLE_FINAL_DETECTION_VERDICT.md",
    "reports/final/phase12_18b_request_handling_final_rerun.json",
    "reports/final/phase12_18b_final_detection_verification.json",
    "reports/final/phase12_18b_runtime_reset_report.json",
    "reports/final/phase12_18b_eval_set_summary.json",
    "reports/final/phase12_18b_detector_routing_audit.json",
    "reports/final/phase12_18b_mutantshield_controlled_eval.json",
