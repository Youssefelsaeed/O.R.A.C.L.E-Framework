# Phase 12.18B Original Metric Comparison
...
## Explanation
- Historical training/validation metrics are not equivalent to external balanced validation.
- Production, candidate, mapped-domain, and native-adapter paths must be reported separately.
- Use Phase 12.18B controlled metrics for presentation unless superseded by a larger fresh rerun.
